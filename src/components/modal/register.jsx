...
export default function Register_Modal()
{
    ...
    return(
        <>
        <button onClick={toggleModal} className="text-white bg-green-700 px-4 py-2 rounded-xl hover:bg-green-600" >Đăng ký
        </button>
        ...
        {modal && <div className="modal">
            <div className="modal fixed inset-0 flex justify-center items-center z-50">
                    ...
                    <div className="modal-content bg-white p-8 rounded-lg shadow-lg relative z-10">
                        <h2 className="text-center text-xl mb-4">Đăng ký tài khoản</h2>
                        ...
                        <form>
                            ...
                            <div className="mb-4">
                                <label htmlFor="confirm password" className="block">Confrim password:</label>
                                <input
                                    type="password"
                                    id="confirm_password"
