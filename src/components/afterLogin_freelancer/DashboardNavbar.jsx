...
//                 to="/freelancer/profile"
//                 onClick={() => setShowMobileMenu(false)}
//                 className="flex items-center px-3 py-2 text-sm font-medium text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg"
//               >
//                 <FaUser className="w-4 h-4 mr-2" />
//                 Hồ sơ
//               </Link>
...
//                 }}
//                 className="flex items-center w-full px-3 py-2 text-sm font-medium text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg"
//               >
//                 <FaSignOutAlt className="w-4 h-4 mr-2" />
//                 Đăng xuất
//               </button>
