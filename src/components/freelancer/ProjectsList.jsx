...
import ProjectDetailModal from "../content-box/ProjectDetailModal";
...
const projects = [
  {
    ...
    description:
      "Cần một freelancer thiết kế giao diện hiện đại, responsive. Ưu tiên biết TailwindCSS.",
    budget: "$300 - $500",
    duration: "2 tuần",
  ...
  },
  {
    ...
    description:
      "Tìm người có kiến thức cơ bản về cybersecurity để viết 5 bài blog, mỗi bài 800 từ.",
    budget: "$100 - $200",
    duration: "1 tuần",
...
export default function ProjectsList() {
  ...
  const [showModal, setShowModal] = useState(false); // ✅ cần thêm state này
  ...
  const closeModal = () => {
    // Chờ animation kết thúc rồi mới set null
    setShowModal(false);
    setTimeout(() => setSelectedProject(null), 500); // thời gian khớp animation
  };
